...
export const updateTeamAction = (id, createWholeTeam, createPlayersData) => async (dispatch) => {
  try {
    const { data } = await api.updatePlayers(id, createWholeTeam, createPlayersData);
